					...
					<ul>
						...
						<li class="xn-openable">
							...
							<ul>
								...
								<li>
									<a href="/principal/classroom#teacher-tab"><span class="fa fa-user"></span>Teacher</a>
								</li>
								<li>
									<a href="/principal/classroom#reports-tab"><span class="fa fa-bar-chart-o"></span> Reports</a>
								</li>
						...
						<li class="xn-openable">
							...
							<ul>
								<li>
									<a href="/principal/create#role-tab"><span class="fa fa-tags"></span>Role</a>
								</li>
								<li>
									<a href="/principal/create#grade-tab"><span class="fa fa-building-o"></span>Grade</a>
								</li>
								<li>
									<a href="/principal/create#subject-tab"><span class="fa fa-book"></span>Subject</a>
								</li>
								<li>
									<a href="/principal/create#staff-tab"><span class="fa fa-user"></span>Staff</a>
								</li>
								<li>
									<a href="/principal/create#student-tab"><span class="fa fa-users"></span>Student</a>
								</li>
								<li>
						...
						<div class="pull-right">
							...
							<div class="x-features-profile">
								...
								<ul class="xn-drop-left animated zoomIn">
									<li>
										<a href="/profilepage"><span class="fa fa-user"></span> Profile</a>
									</li>
