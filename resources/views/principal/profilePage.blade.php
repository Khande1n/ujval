				...
				<div class="panel panel-default">
					...
					<div class="panel-body form-group-separated">
						...
						<div class="form-group">
							...
							<div class="col-md-9 col-xs-7">
								<input type="text" value=" {{ ucwords(Auth::user()->bday) }} " class="form-control"/>
							</div>
						</div>
			...
			<form action="#" class="form-horizontal">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<p>
							The below mentioned are your details. Please update, if any.
						</p>
					</div>
					<div class="panel-body form-group-separated">
						<!-- <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-9 col-xs-7">
								<input type="text" value="" placeholder=" {{ $addressAU['add1'] }} " class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 col-xs-5 control-label">Address Line 2</label>
							<div class="col-md-9 col-xs-7">
								<input type="text" value="" placeholder=" {{ $addressAU['add2'] }} " class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 col-xs-5 control-label">Street</label>
							<div class="col-md-9 col-xs-7">
								<input type="text" value="" placeholder=" {{ $addressAU['street'] }} " class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 col-xs-5 control-label">City</label>
							<div class="col-md-9 col-xs-7">
								<input type="text" value="" placeholder=" {{ $addressAU['city'] }} " class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 col-xs-5 control-label">State</label>
							<div class="col-md-9 col-xs-7">
								<input type="text" value="" placeholder=" {{ $addressAU['state'] }} " class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 col-xs-5 control-label">Country</label>
							<div class="col-md-9 col-xs-7">
								<input type="text" value="" placeholder=" {{ $addressAU['country'] }} " class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 col-xs-5 control-label">Pincode</label>
							<div class="col-md-9 col-xs-7">
								<input type="text" value="" placeholder=" {{ $addressAU['pincode'] }} " class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12 col-xs-5">
								<button type="submit"  class="btn btn-primary btn-rounded pull-right">
									<a href="/staff/{{ Auth::user()->id }}/edit"> Update </a>
								</button>
							</div>
						</div>
					</div>
		...
		<div class="col-md-3">
			<div class="panel panel-default form-horizontal">
				<div class="panel-body">
					...
					<p>
						Some quick info about this user
					</p>
				</div>
				<div class="panel-body form-group-separated">
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-md-4 col-xs-5 control-label">Contact 1</label>
						<div class="col-md-8 col-xs-7 line-height-30">
							{{ $addressAU['contact11'] }}
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 col-xs-5 control-label">Contact 2</label>
						<div class="col-md-8 col-xs-7 line-height-30">
							{{ $addressAU['contact12'] }}
						</div>
					</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-success disabled" id="cp_accept">
					Accept
				</button>
...
<div class="modal animated fadeIn" id="modal_change_password" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer faucibus, est quis molestie tincidunt
				</p>
			</div>
